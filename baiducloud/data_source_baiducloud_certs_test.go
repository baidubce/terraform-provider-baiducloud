...
func TestAccBaiduCloudCertDataSource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCertDataSourceConfig(BaiduCloudTestResourceTypeNameCert),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testAccCertsDataSourceName, testAccCertsDataSourceAttrKeyPrefix+"cert_name", BaiduCloudTestResourceTypeNameCert+"-cert"),
...
func testAccCertDataSourceConfig(name string) string {
	return fmt.Sprintf(`
...
resource "baiducloud_cert" "default2" {
  cert_name         = "%s"
  cert_server_data  = baiducloud_cert.default.cert_server_data
  cert_private_data = baiducloud_cert.default.cert_private_data
}
